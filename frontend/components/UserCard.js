...
const UserCard = ({ imageSource, userName, userRole, onEdit, userClass, indexNumber, onDelete, onLongPress, isShowAction = true }) => {
  return (
    <TouchableOpacity onPress={onEdit} onLongPress={onLongPress}>
